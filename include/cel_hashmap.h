...
typedef void ( * cel_hashmap_rcb_fn_t ) ( void * );
...
// clear the specified hash map
CEL_API void cel_hashmap_clear( cel_hashmap_t *, cel_hashmap_rcb_fn_t );
...
CEL_API int cel_ihashmap_init( cel_ihashmap_t *, int, float );
CEL_API int cel_ihashmap_destroy( cel_ihashmap_t * );
...
CEL_API int cel_ihashmap_inc( cel_ihashmap_t *, char *, int);

// decrease the value associated with the specified key.
CEL_API int cel_ihashmap_dec( cel_ihashmap_t *, char *, int);
...
CEL_API void cel_ihashmap_clear( cel_ihashmap_t * );
/*}}}*/
#endif    /*end ifndef*/
/*}}}*/
