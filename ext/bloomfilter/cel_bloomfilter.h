...
/**
 * get the optimal bits for the specified bloom filter
 *
 * @param   int estimate amounts
 * @param   double false prositive rate
 * @return  int
*/
CEL_API int cel_bloomfilter_optimal_bits(int, double);

/**
 * get the optimal hash functions for the specified bloom filter
 *
 * @param   int estimate amounts
 * @param   int total bits
*/
CEL_API int cel_bloomfilter_optimal_hfuncs(int, int);
