 ...
 */
static cel_link_node_t *create_link_node(
    void * value, cel_link_node_t *_prev, cel_link_node_t *_next) 
{
...
CEL_API void * cel_link_set_obj(
    cel_link_t *link, void *search, void *value, cel_compare_fn_t comp)
{
    void * v;
    cel_link_node_t *o;
